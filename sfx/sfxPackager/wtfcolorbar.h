...
class CWTFColorButton;
class CWTFPropertyGridCtrl;
class CMFCRibbonColorButton;

/*============================================================================*/
// CWTFColorBar window

class CWTFColorBar : public CMFCPopupMenuBar
{
	friend class CWTFToolBarColorButton;
	friend class CWTFColorPopupMenu;
	friend class CWTFColorMenuButton;
...
protected:
	CWTFColorBar(const CArray<COLORREF, COLORREF>& colors, COLORREF color, LPCTSTR lpszAutoColor, LPCTSTR lpszOtherColor, LPCTSTR lpszDocColors,
	...
	CWTFColorBar(CWTFColorBar& src, UINT uiCommandID);
...
protected:
	...
	CWTFColorButton*    m_pParentBtn;
	CWTFPropertyGridCtrl*      m_pWndPropList;
...
protected:
	...
	void SetPropList(CWTFPropertyGridCtrl* pWndList) { m_pWndPropList = pWndList; }
};
