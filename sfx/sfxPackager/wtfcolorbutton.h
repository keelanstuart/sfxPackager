...
class CWTFColorPopupMenu;

/*============================================================================*/
// CWTFColorButton window

class CWTFColorButton : public CMFCButton
{
	friend class CWTFColorBar;

	DECLARE_DYNAMIC(CWTFColorButton)
...
public:
	...
	static void __stdcall SetColorName(COLORREF color, const CString& strName) { CWTFColorBar::SetColorName(color, strName); }
