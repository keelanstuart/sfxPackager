...
extern UINT WTF_WM_GETDOCUMENTCOLORS;

class CWTFColorMenuButton : public CMFCToolBarMenuButton  
{
	DECLARE_SERIAL(CWTFColorMenuButton)

public:
	CWTFColorMenuButton();
	CWTFColorMenuButton(UINT uiCmdID, LPCTSTR lpszText, CPalette* pPalette = NULL);
	virtual ~CWTFColorMenuButton();
