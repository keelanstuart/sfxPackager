...
/*============================================================================*/
// CWTFPropertyGridToolTipCtrl window

class CWTFPropertyGridToolTipCtrl : public CWnd
{
	DECLARE_DYNAMIC(CWTFPropertyGridToolTipCtrl)
...
// Implementation
public:
	virtual ~CWTFPropertyGridToolTipCtrl();
