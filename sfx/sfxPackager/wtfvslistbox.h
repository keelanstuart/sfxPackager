...
#define WTF_VSLISTBOX_BTN_NEW    0x0001
#define WTF_VSLISTBOX_BTN_DELETE 0x0002
#define WTF_VSLISTBOX_BTN_UP     0x0004
#define WTF_VSLISTBOX_BTN_DOWN   0x0008

#define WTF_VSLISTBOX_BTN_NEW_ID    (UINT)(-11)
#define WTF_VSLISTBOX_BTN_DELETE_ID (UINT)(-12)
#define WTF_VSLISTBOX_BTN_UP_ID     (UINT)(-13)
#define WTF_VSLISTBOX_BTN_DOWN_ID   (UINT)(-14)

/*============================================================================*/
// CVSListBoxBaseEx window - edit list control abstract base class
// 

class CVSListBoxBaseEx : public CStatic
{
	DECLARE_DYNAMIC(CVSListBoxBaseEx)
...
// Operations
public:
	BOOL SetStandardButtons(UINT uiBtns = WTF_VSLISTBOX_BTN_NEW | WTF_VSLISTBOX_BTN_DELETE | WTF_VSLISTBOX_BTN_UP | WTF_VSLISTBOX_BTN_DOWN);
...
class CVSListBoxEditCtrlEx : public CMFCEditBrowseCtrl
{
	DECLARE_DYNAMIC(CVSListBoxEditCtrlEx)

	// Construction
public:
	CVSListBoxEditCtrlEx();

	// Attributes
protected:
	BOOL m_bLocked;
	CVSListBoxBaseEx* m_pParentList;

	// Operations
public:
	void LockSize(CVSListBoxBaseEx* pParent, BOOL bLock = TRUE);

	// Implementation
public:
	virtual ~CVSListBoxEditCtrlEx();
...
class CVSListBoxEx : public CVSListBoxBaseEx
{
	DECLARE_DYNAMIC(CVSListBoxEx)
...
protected:
	CPoint        m_ptClick;
	CVSListBoxEditCtrlEx m_wndEdit;
